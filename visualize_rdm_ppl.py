...
if __name__ == "__main__":
    ...
    folder_name = 'Deformed_random_Images'
    ...
    for cls in folders:
        ...
        for file in file_list:
            ...
            origin = Normalize()(pointcloud)

            new1, _ = FreeFormDeformation(np.asarray(origin), num_points=60, points=5)
            new2, _ = FreeFormDeformation(np.asarray(origin), num_points=60, points=5)
